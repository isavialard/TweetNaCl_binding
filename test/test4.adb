...
-- Here we use twice a nonce on two messages.
-- It can be compiled and executed, but fails at proof stage
...
procedure Test4 is
   ...
   M_Alice_2 : constant Plain_Text := (16#41#, 16#64#, 16#61#, 16#20#, 16#69#,
                                       16#73#, 16#20#, 16#74#, 16#68#, 16#65#,
                                       16#20#, 16#70#, 16#72#, 16#65#, 16#74#,
                                       16#74#, 16#69#, 16#65#, 16#73#, 16#74#,
                                       16#20#, 16#6f#, 16#66#, 16#20#, 16#61#,
                                       ...
                                       16#6e#, 16#67#, 16#75#, 16#61#, 16#67#,
                                       16#65#, 16#73#);
   SM_Alice_2  : Plain_Text (M_Alice'First .. M_Alice'Last + 64);
   C_2   : Cipher_Text (SM_Alice'First .. SM_Alice'Last + 32);
   SM_Bob_2 : Plain_Text (C'First .. C'Last - 32);
   M_Bob_2  : Plain_Text (SM_Bob'First .. SM_Bob'Last - 64);

begin
   Put_Line (" Original message 1 = ");
   ...
   Put_Line (" Original message 2 = ");
   for i in M_Alice'First .. M_Alice'Last loop
      Put (u8'Image (M_Alice_2 (i)));
   end loop;
   Put_Line ("");

   -- Alice signs her message using her signing secret key

   Crypto_Sign (SM_Alice_2, M_Alice_2, Sign_SK_Alice);
   Put (" Signed message = ");
   for i in SM_Alice'First .. SM_Alice'Last loop
      Put (u8'Image (SM_Alice_2 (i)));
   end loop;
   Put_Line ("");
   ...
   Crypto_Box (C_2, SM_Alice_2, N, PK_Bob, SK_Alice);
   Put (" Encrypted message sent to Bob = ");
   for i in C'First .. C'Last loop
      Put (u8'Image (C_2 (i)));
   end loop;
   ...
   Crypto_Box_Open (SM_Bob_2, C_2, N, PK_Alice, SK_Bob);
   Put (" Decrypted message = ");
   for i in SM_Bob'First .. SM_Bob'Last loop
      Put (u8'Image (SM_Bob_2 (i)));
   end loop;
   Put_Line ("");

   -- Bob unsigns the message with Alice signing public key

   Crypto_Sign_Open (M_Bob_2, SM_Bob_2, Sign_PK_Alice);
   Put (" Final message = ");
   for i in M_Bob'First .. M_Bob'Last loop
      Put (u8'Image (M_Bob_2 (i)));
   end loop;
   Put_Line ("");
